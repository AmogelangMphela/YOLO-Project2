...
The All credit for the code goes to the author of the github repository found at: https://github.com/z1069614715/objectdetection_script/tree/master and 
was used only for the purpose of visualizing the attention maps since the authors of EigenCAM did not provide code that is compatible with YOLO
I, Amogelang Mphela do not claim any credit for this code.
...
def get_params():
    params = {
        'weight': 'TrainResults/yolov5n(cbam-backbone)/train/weights/best.pt', 
        'device': 'cuda:0',
        'method': 'EigenCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM
...
# pip install grad-cam==1.5.4 --no-dep
if __name__ == '__main__':
    model = yolo_heatmap(**get_params())
    model(r'theimages', 'result')
